<template>
  <div class="about">
    ...
    <div class="menu">
      <div class="nome">
        <label for="temptime">Data </label>
        <input type="datetime-local" id="temptime" name="temptime" v-model="dataHora" />
      </div>
    <div class="medida">
    ...
    <div class="particula">
      <label for="particula">Particulas </label>
      <input id="particula" type="text" v-model="particulas" />
    </div>  
